            ...
            <div class="row">
                        ...
                        <div class="single-blog">
                            ...
                            <div class="blog-content">
                                ...
                                <p>When replacing a multi-lined selection of text, the generated dummy text maintains
                                    the amount. The generated dummy text maintains the amount</p>
                            </div>
                        </div>
                    </div>
                    <!-- End single blog -->
                    ...
                    <div class="single-blog">
                        ...
                        <div class="blog-content">
                            ...
                            <p>When replacing a multi-lined selection of text, the generated dummy text maintains the
                                amount. The generated dummy text maintains the amount</p>
                        </div>
                    </div>
                </div>
                <!-- End single blog -->
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="single-blog">
                        <div class="blog-image">
                            <a class="image-scale" href="#">
                                <img src="{{ config('app.url') }}/img/blog/b5.jpg" alt="">
                            </a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="single-blog">
                        <div class="blog-image">
                            <a class="image-scale" href="#">
                                <img src="{{ config('app.url') }}/img/blog/b6.jpg" alt="">
                            </a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
