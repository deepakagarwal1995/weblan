...
<div class="intro-area intro-area-2">
    ...
    <div class="intro-carousel">
        ...
        <div class="intro-content">
            <div class="slider-images">
                <img src="{{ config('app.url') }}/img/slider/h4.jpg" alt="">
            </div>
            <div class="slider-content">
                <div class="display-table">
                    <div class="display-table-cell">
...
<!-- Start project Area -->
<div class="location-area bg-color area-padding fix">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="section-headline text-center">
        ...
        <div class="row">
            <div class="location-carousel location-content">
                <!-- single-awesome-project start -->
                <div class="location-single">
                    <div class="single-awesome-location">
                        <div class="location-awesome-img">
                            <a class="venobox" data-gall="myGallery" href="img/location/p1.jpg">
                                <img src="{{ config('app.url') }}/img/location/p1.jpg" alt="" />
                                <div class="location-add-actions">
                                    <div class="location-dec">
                ...
                <div class="location-single">
                    <div class="single-awesome-location">
                        <div class="location-awesome-img">
                            <a class="venobox" data-gall="myGallery" href="img/location/p2.jpg">
                                <img src="{{ config('app.url') }}/img/location/p2.jpg" alt="" />
                                <div class="location-add-actions">
                                    <div class="location-dec">
                                        <h4>Almas Tower</h4>
                                        <span>Dubai , UAE</span>
                ...
                <div class="location-single">
                    <div class="single-awesome-location">
                        <div class="location-awesome-img">
                            <a class="venobox" data-gall="myGallery" href="img/location/p3.jpg">
                                <img src="{{ config('app.url') }}/img/location/p3.jpg" alt="" />
                                <div class="location-add-actions">
                                    <div class="location-dec">
                                        <h4>Capita Green</h4>
                                        <span>Singapore City , Singapore</span>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <div class="location-single">
                    <div class="single-awesome-location">
                        <div class="location-awesome-img">
                            <a class="venobox" data-gall="myGallery" href="img/location/p4.jpg">
                                <img src="{{ config('app.url') }}/img/location/p4.jpg" alt="" />
                                <div class="location-add-actions">
                                    <div class="location-dec">
                                        <h4>Central Plaza</h4>
                                        <span>Hong Kong city , Hong Kong</span>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <div class="location-single">
                    <div class="single-awesome-location">
                        <div class="location-awesome-img">
                            <a class="venobox" data-gall="myGallery" href="img/location/p4.jpg">
                                <img src="{{ config('app.url') }}/img/location/p5.jpg" alt="" />
                                <div class="location-add-actions">
                                    <div class="location-dec">
                                        <h4>Empire Tower</h4>
                                        <span>Bangkok city , Thailend</span>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <div class="location-single">
                    <div class="single-awesome-location">
                        <div class="location-awesome-img">
                            <a class="venobox" data-gall="myGallery" href="img/location/p4.jpg">
                                <img src="{{ config('app.url') }}/img/location/p6.jpg" alt="" />
                                <div class="location-add-actions">
                                    <div class="location-dec">
                                        <h4>Heron Tower</h4>
                                        <span>London , UK</span>
